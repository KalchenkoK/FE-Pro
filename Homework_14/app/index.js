...
// const resetegf = STDIN.getOperationInput(validationMessageName, validationOperationName);
// console.log(resetegf);

const someFunctions = {
  firstName: STDIN.getOperationInput(
    validationMessageName,
    validationOperationName
  ),
  lastName: STDIN.getOperationInput(
    validationMessageLastName,
    validationOperationName
  ),
  // age: STDIN.getOperationInput(validationMessageYear, validationOperationYear, coerceAgeToNumber),
  age: ageUser(),
...
for (const el of data) {
  ...
  if (text in someFunctions) {
    //  console.log(someFunctions[text]);
    // someFunctions[text]();
